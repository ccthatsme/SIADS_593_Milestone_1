...
def merge_datasets(left_df, right_df, left_merge_keys, right_merge_keys, how, validate = None, indicator = False):
    """Merge two datasets"""    
    return pd.merge(left_df, right_df, left_on=left_merge_keys, right_on=right_merge_keys, how=how, validate=validate, indicator=indicator)